...
const Сonverter = () => {
    ...
    return (
        ...
        >
            <form
                action=''
                //className='flex flex-col bg-gray-200 border border-gray-800 items-center w-66 h-40'
                className='flex flex-col bg-green-200 border border-gray-800 items-center w-44 h-40'
            >
                ...
                <input
                    ...
                    id='check'
                    onInput={(e) => handler(e)}
                    className='input mx-auto text-center border border-green-300 text-sm block w-40 p-2.5' //rounded-lg 
                    required
                />
                ...
                <input
                    ...
                    id='result'
                    value={rgb}
                    className='result mx-auto bg-gray-50 border border-green-300 text-center text-gray-900 text-sm block w-40 p-2.5'//rounded-lg
                    disabled
                />
            </form>
        </div>
